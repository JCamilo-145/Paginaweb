...
<head>
    ...
    <title>Python: El Lenguaje que Revolucionó la Programación</title>
    <style>
        :root {
            --primary: #306998; /* Python blue */
            --secondary: #FFD43B; /* Python yellow */
            --third: #646464; /* Python grey */
            --light: #f8f9fa;
            --dark: #212529;
            --code-bg: #f1f1f1;
        }
            ...
            <div class="timeline">
                ...
                <div class="timeline-item left">
                    <div class="timeline-content">
                        ...
                        <p>Python continúa su crecimiento, es el segundo lenguaje más popular según el índice TIOBE y sigue evolucionando con mejoras en rendimiento, sintaxis y funcionalidades.</p>
                    </div>
                </div>
            </div>
        </div>
